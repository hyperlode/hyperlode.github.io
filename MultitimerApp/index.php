  ...
  <body role="document">
    ...
    <div class="container theme-showcase" role="main">
      ...
      <div class="jumbotron">
        ...
        <p>The MultiTimer works much like an advanced chess clock, without the two players limitation. It adds an extra level of excitement to games and prevents them from becoming boring. Really, it makes playing scrabble with your parents fun again!
		</p>
		
		<h2>Try the software app!</h2>
		<div class= "col-md-2">
		<p>
		<a href="http://lode.ameije.com/MultitimerApp/multitimer_app.html"> Go to the app </a>!
				
		</p>
		</div>
		<div class= "col-md-10">
		 <a href="http://lode.ameije.com/MultitimerApp/multitimer_app.html"><img src="/images/appIcon.png" alt="Click to start"></a>
		</div>
		
		<h2>How real MultiTimer works</h2>
		<div class= "col-md-9">
		<p>
		...
		<p>
		Hurray!! We will be at the Vancouver Mini Maker Faire the 6th and 7th of June! There I will be showing of the possibilities of my MultiTimer.
