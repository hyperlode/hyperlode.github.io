...
function padding(stringToBePadded, paddingCharacter, totalLength, padLeftElseRight){
	...
	var paddingString = "" ;  //paddingCharacter.repeat(totalLength);//make long string of padding characters   repeat not yet implemented for many browsers!!!!https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String/repeat
