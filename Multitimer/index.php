  ...
  <body role="document">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
		...
		<ul class="nav navbar-nav navbar-right">
		 <li ><a href="http://lode.ameije.com">extra</a></li>
    ...
    <div class="container theme-showcase" role="main">
      ...
      <div class="jumbotron">
        ...
        <p>The MultiTimer works much like a chess clock, without the two players limitation. 
			<ul>
				<li>It prevents the eternal discussions between "slow" and "fast" players.</li> 
				<li>Having a predefined amount of time enables you to schedule a fun game even if "you don't have all night"</li> 
				<li>Having a limited amount of time adds an extra level of excitement to games and keeps the pace up. </li> 
				<li>It allows players with different skill levels to have a fun game together by assigning a time handicap.</li> 
			</ul>
			<br>Really, it even makes playing scrabble with your parents fun again!
		</p>
	...
	<div class="row">
		...
		<div class= "col-md-12">
			<h2>Maker Faire 2017: The MultiTimer and Friends Aftermath</h2>
		</div>
		<div class= "col-md-9">
			<p>
				...
				<ul>
				<li>
					The friend of the MultiTimer is Joey with his awesome project. Whenever a song is played from iTunes, the orginal record artwork in shown a nice frame (a well hidden computer screen, powered by a raspberry pi zero).<br>
					His project can be <a href="http://www.tapesong.com">downloaded from his site</a>. Check it out!
				</li>
				<li><a href="http://vancouver.makerfaire.com/maker/entry/91/"> <img align= "right" width ="100px" src="/images/erica_frankenstuffy.jpg" alt="Erica shows off her Franken Stuffie. "></a>Also a shoutout to another very very enthusiastic crew member Erica, shown here with a creation she made at our favorite booth. You are the MultiTimer's best friend! 
				</li>
				<li>
					The game that was shown on the table is called Quoridor. It's a beautiful, elegant, easy explained<a href="https://en.wikipedia.org/wiki/Quoridor">  game</a>.<br>
					I love it so much, I made a <a href="http://lode.ameije.com/QuoridorApp/quoridor.html">software version</a> of the game that can be played with two players. Give it a try!
				</li>
					
				
				
				<li>The MultiTimer is in a mature state. Only time will tell if there will be a next generation. But, it is said that software projects are never finished, only abandoned. So, I am afraid we didn't see the end of my pet project yet. You can always contact me if you have any questions or requests about the MultiTimer or anything else for that matter! See you around!
				</li>
			</ul>
			</p>
		...
		<div class= "col-md-3">
			...
			<a href="http://vancouver.makerfaire.com/maker/entry/46/"><img width ="100%" src="/images/booth2017.jpg" alt="all images for the drawing challenge"></a>
		</div>		
	
	
		<div class= "col-md-12">
			<h2>Maker Faire 2017: The one minute drawing challenge</h2>
		</div>
		<div class= "col-md-9">
			<p>
				Thanks to all participants that allowed us to lure them into this challenge.<br>
				We were sorting and scanning and publishing, and it was all worth it! Have a look for yourself, go to 
				<a href="http://lode.ameije.com/BicycleDrawChallenge/Thumbnails.html">the results!</a>
		...
		<div class= "col-md-3">
			...
			<a href="http://lode.ameije.com/BicycleDrawChallenge/Thumbnails.html"><img width ="100%" src="/images/bicylceDrawing.png" alt="all images for the drawing challenge"></a>
		</div>		
